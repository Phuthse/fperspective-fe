...
import { LineChartPostWeek, TotalPostWeek } from '../PostCharts/PostWeek/user-analytic-post-chart-week';
import { LineChartPostMonth, TotalPostMonth } from '../PostCharts/PostMonth/user-analytic-post-chart-month';
import { LineChartPostYear, TotalPostYear } from '../PostCharts/PostYear/user-analytic-post-chart-year';
import { LineChartPostAll, TotalPostAll } from '../PostCharts/PostAllTime/user-analytic-post-chart-all';
        ...
        <>
            <div className="user-analytic-post-filter">
                ...
                <h2>
                    ...
                    <span className='analytic-total-comment'>&nbsp;({totalPost})</span>
                </h2>
            </div>
            {selectedChart}
        </>
