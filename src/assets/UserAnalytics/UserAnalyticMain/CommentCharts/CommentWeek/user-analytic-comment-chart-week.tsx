...
export function TotalCommentWeek() {
    const totalCommentData = [10, 30, 123, 421, 320, 321, 832, 200];
    const sum = totalCommentData.reduce((acc, value) => acc + value, 0);
    return sum;
}

export function LineChartCommentWeek() {
    ...
    const CommentData = [10, 30, 123, 421, 320, 321, 832, 200];
    ...
    return (
        <LineChart className='' width={1000} height={500} data={data}>
            ...
            <Line type="monotone" dataKey="TotalComment" stroke="rgb(59, 160, 255)" />
            <Tooltip
                contentStyle={{
                    background: '#111',
