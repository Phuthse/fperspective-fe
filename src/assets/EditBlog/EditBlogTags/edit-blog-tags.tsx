...
const EditBlogTags: React.FC<CreateBlogTagsProps> = ({ setTags, uri, currentTags }) => {
  ...
  const [tags, setTagsState] = useState<Tag[]>(currentTags);
