...
const CategoryFilteredHomePageFilter: React.FC = () => {
    ...
    return (
        <header className='home-page-filter'>
            <div className='home-page-filter-left'>
                <Link
                    to={`/category/${categoryFilter}/latest`}
                ...
                <Link
                    to={`/category/${categoryFilter}/top`}
            ...
            <div className='home-page-filter-right' style={{ display: showTopOptions ? 'block' : 'none' }}>
                <Link
                    to={`/category/${categoryFilter}/top/week`}
                ...
                <Link
                    to={`/category/${categoryFilter}/top/month`}
                ...
                <Link
                    to={`/category/${categoryFilter}/top/year`}
                ...
                <Link
                    to={`/category/${categoryFilter}/top/all`}
...
export default CategoryFilteredHomePageFilter;
