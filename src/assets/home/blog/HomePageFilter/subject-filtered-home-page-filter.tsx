...
const SubjectFilteredHomePageFilter: React.FC = () => {
    ...
    return (
        <header className='home-page-filter'>
            <div className='home-page-filter-left'>
                <Link
                    to={`/subject/${subjectFilter}/latest`}
            ...
            <div className='home-page-filter-right' style={{ display: showTopOptions ? 'block' : 'none' }}>
                <Link
                    to={`/subject/${subjectFilter}/top/week`}
                ...
                <Link
                    to={`/subject/${subjectFilter}/top/month`}
                ...
                <Link
                    to={`/subject/${subjectFilter}/top/year`}
                ...
                <Link
                    to={`/subject/${subjectFilter}/top/all`}
...
export default SubjectFilteredHomePageFilter;
